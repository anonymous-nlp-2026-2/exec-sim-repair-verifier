...
\begin{figure}[h]
\centering
\includegraphics[width=\columnwidth]{figures/paper/fig_mutation_heatmap.pdf}
...
\caption{TOST $p$-value as a function of equivalence margin. \cls{}--\cwm{} (blue) achieves equivalence at $\pm$1.52\pp{}; \cls{}--\traj{} (green) crosses $\alpha{=}0.05$ near $\pm$1.8\pp{} but does not survive Holm correction. Log scale.}
...
Claude (Anthropic) assisted with code, writing, and literature review.
