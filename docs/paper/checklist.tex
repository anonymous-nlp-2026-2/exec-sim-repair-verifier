...
Yes. Section~\ref{sec:conclusion} (Limitations paragraph) discusses: ${\leq}$8B LoRA scope and generalization beyond this regime, Python-only evaluation domain, and synthetic mutation vs.\ real bug representativeness. Section~\ref{sec:threats} discusses checkpoint selection, preprocessing, and seed coverage. Extended validity discussion in Appendix~\ref{app:limitations}.
...
Yes. See Appendix~\ref{app:ai-assistants} for details on the AI assistant (Claude, Anthropic) used for code development, writing, and literature summarization.
