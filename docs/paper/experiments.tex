...
Few-shot prompting (3-shot in-context learning) collapses to an always-predict-unresolved baseline (variant accuracy 45.83\%, below majority 54.17\%; Appendix~\ref{app:few_shot}); execution-free verification requires task-specific fine-tuning regardless of formulation. Fine-tuning yields 35--36\pp{} gains (Table~\ref{tab:repo_level}), a prerequisite before formulation choice becomes relevant.
...
\begin{figure}[t]
\centering
\includegraphics[width=\columnwidth]{figures/paper/fig_cwm_unparseable.pdf}
